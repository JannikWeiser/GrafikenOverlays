...
## 7. General inference recipe (any discipline)

Both the qualification-route case (§5) and the Speed-elimination case (§6)
follow the same shape of algorithm, just over different underlying lists —
worth internalizing as the general pattern for "what's currently
happening" against this API:
...
## 8. How to verify a claim in this document
